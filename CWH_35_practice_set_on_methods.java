...
public class CWH_35_practice_set_on_methods {
    ...
    static int avgN(int...num){
        int elements = num.length;
        int sum = 0;
        for(int a: num){
            sum +=a;
        }
    ...
    static float temperature(float c){
        float f;
        f = 9*c/5 + 32;
        return f;
    }
    ...
    public static void main(String[] args) {
      ...
      //  int c= sumRec(4);
       ...
       // pattern2_rec(5);
        ...
        // Problem 6
      //  System.out.println("Average Of given number is : " +avgN(5, 6,9,8,2 ));
        ...
        System.out.println("The given celcius temperature in farenheit is : " +temperature(a));
